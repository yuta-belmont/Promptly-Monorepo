#!/usr/bin/env python3
"""
Script to set environment variables for the Promptly server.
This script should be imported before running the server.
"""
...
def set_environment_variables():
    ...
    if env_path.exists():
        ...
        logger.warning("No .env file found in server directory")
    ...
    if not firebase_credentials_path:
        ...
        logger.info(f"Set FIREBASE_SERVICE_ACCOUNT to {firebase_credentials_path}")
